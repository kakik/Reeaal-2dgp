...
class Zombie:
    ...
    def update(self):
        ...
        for game_object in game_world.all_objects():
            if game_object == main_state.boy:
                if self.x - 100 < game_object.x < self.x + 100 and self.y - 100 < game_object.y < self.y + 100:
                    ranking_state.rank.add_rank((get_time() - main_state.boy.start_time))
