...
class WalkingState:
    ...
    def do(boy):
        ...
        boy.y = clamp(0+70, boy.y, boy.bg.h-20)
        boy.x = clamp(1.0/math.tan(80.0*math.pi/180.0)*boy.y, boy.x, boy.bg.w - 1.0/math.tan(80.0*math.pi/180.0)*boy.y)
...
class Boy:
    ...
    def draw(self):
        ...
        self.font.draw( self.x - self.bg.window_left-50, self.y - self.bg.window_bottom+60, '%5d' % self.ate_ball_num, (255, 255, 0))
